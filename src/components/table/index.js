...
import {getTableRaw} from "../../store/actions/patientList/index";
            ...
            .map((row, index) => (
              <TableRow
                ...
                onClick={() => {
                  ...
                  setSelectedRow(row);
                  dispatch(getTableRaw(row));
                }}
                selected={selectedID === row[rowID]}
                classes={{ hover: classes.hover, selected: classes.selected }}
                className={classes.tableRow}
              >
                {columnMap.map(({ field, type }) => (
                  <TableCell
                    component="th"
                    scope="row"
                    key={`row-${index}-${field}`}
                ...
                {haveActions && (
                  <TableCell component="th" scope="row">
                    ...
                    >
                      {onDone && (
                        <IconButton size="small" onClick={handleRowDone(row)}>
                          {" "}
                          <DoneIcon
                            fontSize="small"
                      ...
                      {onEdit && (
                        <IconButton size="small" onClick={handleRowEdit(row)}>
                          {" "}
                          <EditIcon
                            fontSize="small"
                      ...
                      {onDelete && (
                        <IconButton size="small" onClick={handleRowDelete(row)}>
                          {" "}
                          <DeleteIcon
                            fontSize="small"
